...
\begin{document}
	...
	\end{eqnarray}
	The comparison of the results for these two cases is of great interest. For example, in Refs.~\cite{FL18, FL20} the both cases were studied in parallel. In the current paper, we consider the case of the system of distinguishable particles in more detail, since it was the system we implied in our previous works. However, in Section~\ref{sec:indist} we present the result for the system of indistinguishable particles as well. As will be seen there, the latter case may be of more importance in the context of isomorphism of the double-occupancy cell model to the Blume-Capel model.
