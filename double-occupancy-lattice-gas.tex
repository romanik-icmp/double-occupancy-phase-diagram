...
\begin{document}
	...
	For each $a$ from the interval $\frac{1}{2}\ln 2 < a < 0.5$, a triple point occurs in the system. At this point, three phases with different densities --- I, II, and III --- can coexist at the same temperature and pressure. The numerical results for triple-point coordinates are presented in Table~\ref{tab:triple-line}.
